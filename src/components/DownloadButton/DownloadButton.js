...
function DownloadButton({ handleDownloadText }) {
  return (
    <button className="downloadBtn" onClick={handleDownloadText}>
      <span role="img" aria-label="download" className="downloadBtnIcon">
        <svg
